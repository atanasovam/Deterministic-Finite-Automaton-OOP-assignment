...
Крайните автомати са едни от най-простите модели на изчисление с изключително ог-
раничена памет. По отношение обаче на ефективност те не случайно са и най-приложимите
в практиката. Най-общо казано един краен автомат се дефинира посредством:

- входна азбука – крайно, непразно множество от символи, които могат да бъдат про-
    четени от входната лента посредством така наречения четец;
- крайно множество от състояния – измежду които едно е начално, а нула или повече
    състояния са крайни;
- функция на преходите - отразяваща преминаването между състоянията след прочи-
    тане на входен символ от лентата.

Ако след последователно прочитане на всички символи от лентата сме попаднали в край-
но състояние, то казваме, че думата разположена върху лентата серазпознаваот крайния
автомат. Множеството от всички думи, които се разпознават от даден краен автомат нари-
чаме език, който се разпознава от крайния автомат.
...
Пример: Автоматът M от фиг. 1 формално се дефинира катоM = (Q,Σ, δ, q 0 , F),
където:
